pipeline {
    ...
    tools {
        maven 'Maven 3.8.1' // Adjust to your Maven installation
        jdk 'JDK 11'        // Adjust to your JDK installation
    }
    ...
    stages {
        ...
        stage('OWASP Dependency-Check') {
            steps {
                dependencyCheck additionalArguments: '--format XML --out target --scan .'
